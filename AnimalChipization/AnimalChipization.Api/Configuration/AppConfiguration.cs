...
public static class AppConfiguration
{
    ...
    /* Default values */
    public static string DatabaseConnectionString { get; private set; } = "host=localhost;port=1111;database=animal-chipization;username=postgres;password=postgres";
